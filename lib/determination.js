...
const getQuorum =
  (list, blockHash, txid, full = false) => {
    if (typeof list === 'undefined' || !list) {
      throw new Error('MNlist is undefined or null');
    }
    if (typeof blockHash === 'undefined' || !blockHash) {
      throw new Error('blockHash is undefined or null');
    }
    if (typeof txid === 'undefined' || !txid) {
      throw new Error('txid is undefined or null');
    }
