...
const Validate = (data, signature, quorumData) => new Promise(((resolve) => {
  if (message(JSON.stringify(data))
    .verify(quorumData.refAddr, signature)) {
...
const validate = (data, signature, quorumData) => Validate(data, signature, quorumData);
