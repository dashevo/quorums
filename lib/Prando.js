...
const Prando = /** @class */ (function () {
   ...
   *
   * Note: keep in mind that while the returned item will be random enough, picking
   * one item from the array at a time does not guarantee nor imply that a sequence
   * of random non-repeating items will be picked. If you want to *pick items in a
   * random order* from an array, instead of *pick one random item from an array*,
   * it's best to apply a *shuffle* transformation to the array instead, then read it linearly.
